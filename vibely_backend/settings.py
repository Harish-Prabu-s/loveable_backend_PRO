...
AWS_ACCESS_KEY_ID = os.environ.get('AWS_ACCESS_KEY_ID', 'UtoursgcA6hFq0pKBv7W39QVfaRIEekzMHji')
AWS_SECRET_ACCESS_KEY = os.environ.get('AWS_SECRET_ACCESS_KEY', '0J7dNAmHRQcZSVzwugfb13i25CkOlavsWqY4')
AWS_STORAGE_BUCKET_NAME = os.environ.get('AWS_STORAGE_BUCKET_NAME', 'loveable-bucket')
...
# Media (uploads)
# MEDIA_URL will now be generated by django-storages pointing to S3
MEDIA_URL = '/media/'
